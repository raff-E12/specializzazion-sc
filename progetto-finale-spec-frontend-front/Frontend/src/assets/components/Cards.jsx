                  ...
                  <div className="card-body d-flex flex-column justify-content-between">
                    ...
                    <div className="mt-auto d-flex justify-content-between align-items-center">
                      ...
                      <div className="d-flex gap-2">
                        <button className="btn btn-sm btn-outline-warning favorite-btn" data-id="1" title="Aggiungi ai preferiti"><i class="bi bi-star-fill"></i></button>
                        <button className="btn btn-sm btn-outline-secondary compare-btn" data-id="1" title="Aggiungi al comparatore"><i class="bi bi-people-fill"></i></button>
                      </div>
                    </div>
                  </div>
                </div>
